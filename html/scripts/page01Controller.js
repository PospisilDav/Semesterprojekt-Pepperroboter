...
function page01Controller() {
  ...
  function onGotoIndex() {
    ...
    window.console.log(
      "Page01Controller: Jetzt auf Index-Page (Intro) wechseln"
    );
    pepperCtrl.shutUpAndContinue();
    setTimeout(function () {
      pepperCtrl.playSound(5);
    }, 300);
  ...
  function onGotoSetup() {
    ...
    window.console.log(
      "Page01Controller: Jetzt auf Setup-Page (Volume/Mute) wechseln"
    );
    pepperCtrl.shutUpAndContinue();
    setTimeout(function () {
      pepperCtrl.playSound(5);
  ...
  function setMute() {
    ...
    $("#unmuteImg").replaceWith(
      "<img id='unmuteImg' src='bilder/unmute.png' width='70px'>"
    );
    $("#muteImg").replaceWith(
      "<img id='muteImg' src='bilder/muteGrey.png' width='70px'>"
    );
  }
  ...
  function setUnmute() {
    ...
    $("#muteImg").replaceWith(
      "<img id='muteImg' src='bilder/mute.png' width='70px'>"
    );
    $("#unmuteImg").replaceWith(
      "<img id='unmuteImg' src='bilder/unmuteGrey.png' width='70px'>"
    );
  }
